...
SERVER_URL = "http://10.7.7.199" # change if needed
DATABASE_URL = "http://10.7.7.144" # change if needed
...
async def main(scenario_no, otii_project, device, out_path):
    ...
    r = requests.get(f"{SERVER_URL}/cleardb") # TODO need similar endpoint
